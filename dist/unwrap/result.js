...
class Result {
    ...
    *[Symbol.iterator]() {
        if (this.isOk()) {
            yield (0, option_1.Some)(this.unwrap());
        }
    ...
    err() {
        return this.isErr() ? (0, option_1.Some)(this.variant0) : (0, option_1.None)();
    }
    expect(msg) {
        if (this.isErr()) {
            throw Error(msg);
    ...
    ok() {
        return this.isOk() ? (0, option_1.Some)(this.variant1) : (0, option_1.None)();
    }
    or(result) {
    ...
    transpose() {
        return this.isErr()
            ? (0, option_1.Some)(this)
            : (this.unwrap().isSome() ? (0, option_1.Some)(Ok(this.unwrap().unwrap())) : (0, option_1.None)());
    }
    unwrap() {
